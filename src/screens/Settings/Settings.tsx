    ...
    <div className="settings-overlay" role="dialog" aria-modal="true">
      <div className="settings-panel">
        <header className="settings-header">
          <h2>Settings</h2>
          <button className="close-btn" onClick={() => { playClick?.(); onClose(); }}>
            ✕
          </button>
        </header>
          ...
          <label className="field">
            ...
            {form.avatarDataUrl ? (
              <div className="avatar-section">
                ...
                <button className="clear-avatar-btn" onClick={handleClearAvatar}>Remove Avatar</button>
              </div>
            ) : (
